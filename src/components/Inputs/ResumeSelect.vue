<template>
  <select class="form-select form-select-lg fs-2 font-weight-bold font-monospace" v-model="propModel" @change="onChange()" aria-label=".form-select-lg example">
...
export default {
  name: 'ResumeInput',
  props: ['value', 'options', 'resumeValue'],
  computed: {
    propModel: {
